Audit the implementation against the repository's documented coding standards.

Anything in the repo that documents how code should be written, such as `CONTRIBUTING.md`.
